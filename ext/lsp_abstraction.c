...
static inline bool lsp_latest_string_equals_cstr(zend_string *value, const char *literal, size_t length)
{
	return zend_string_equals_cstr(value, literal, length);
}
...
php_ver_abstract_t php_ver_abstract = {
	...
	lsp_php82_string_equals_cstr
};
#elif PHP_VERSION_ID >= 80100 && PHP_VERSION_ID < 80200
# include "lsp_php81_abstraction.h"

php_ver_abstract_t php_ver_abstract = {
	lsp_php81_ast_kind_name,
	lsp_php81_ast_is_decl,
	lsp_php81_ast_is_opaque_node,
	lsp_php81_string_equals_cstr
};
#elif PHP_VERSION_ID < 80100
# error "LSParrot requires PHP 8.1 or later"
#endif
